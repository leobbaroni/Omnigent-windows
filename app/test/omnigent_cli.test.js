...
// [win] The POSIX candidate list is asserted only off Windows; the Windows
// list (with .exe names and uv's tool bin dir) is covered by test/win_cli.test.js.
describe("candidatePaths", { skip: process.platform === "win32" }, () => {
